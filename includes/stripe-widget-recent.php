...
class wp_stripe_recent_widget extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('stripe-recent-title')); ?>"
                   name="<?php echo esc_attr($this->get_field_name('stripe-recent-title')); ?>"
                   value="<?php echo esc_attr($instance['stripe-recent-title']); ?>"/>
        </p>
        ...
        <p>
            ...
            <select id="<?php echo esc_attr($this->get_field_id('stripe-recent-limit')); ?>"
                    name="<?php echo esc_attr($this->get_field_name('stripe-recent-limit')); ?>">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('stripe-recent-headdesc')); ?>"><?php _e('Text above payments:', 'wp-stripe'); ?></label><textarea
                    class="widefat" rows="5" cols="20"
                    id="<?php echo esc_attr($this->get_field_id('stripe-recent-headdesc')); ?>"
                    name="<?php echo esc_attr($this->get_field_name('stripe-recent-headdesc')); ?>"><?php echo esc_textarea($instance['stripe-recent-headdesc']); ?></textarea>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('stripe-recent-headdesc')); ?>"><?php _e('Text below payments:', 'wp-stripe'); ?></label><textarea
                    class="widefat" rows="5" cols="20"
                    id="<?php echo esc_attr($this->get_field_id('stripe-recent-footdesc')); ?>"
                    name="<?php echo esc_attr($this->get_field_name('stripe-recent-footdesc')); ?>"><?php echo esc_textarea($instance['stripe-recent-footdesc']); ?></textarea>
        </p>
