...
function wp_stripe_field_header()
{
    ...
    <input id="setting_api" name="wp_stripe_options[stripe_header]" type="text" size="40"
...
function wp_stripe_field_test()
{
    ...
    <input id="setting_api" name="wp_stripe_options[stripe_test_api]" class="code" type="text" size="40"
           value="<?php echo esc_attr($value); ?>"/>
...
function wp_stripe_field_test_publish()
{
    ...
    <input id="setting_api" name="wp_stripe_options[stripe_test_api_publish]" class="code" type="text" size="40"
           value="<?php echo esc_attr($value); ?>"/>
...
function wp_stripe_field_prod()
{
    ...
    <input id="setting_api" name="wp_stripe_options[stripe_prod_api]" class="code" type="text" size="40"
           value="<?php echo esc_attr($value); ?>"/>
...
function wp_stripe_field_prod_publish()
{
    ...
    <input id="setting_api" name="wp_stripe_options[stripe_prod_api_publish]" class="code" type="text" size="40"
           value="<?php echo esc_attr($value); ?>"/>
    ...
    <div id="wp-stripe-tabs">
        ...
        <div id="wp-stripe-tab-transactions">
            ...
            <table class="wp-stripe-transactions">
                ...
                <tr>
                    ...
                    <th style="width:44px;">
                        <div class="dot-stripe-live"></div>
                        <div class="dot-stripe-public"></div>
                    </th>
                    <th style="width:200px;">Persone</th>
            ...
            <p style="color:#777">The amount of payments display is limited to 500. Log in to your <a
                        href="https://manage.stripe.com/dashboard">Stripe dashboard</a> to see more.</p>
            <div style="color:#777">
                <div class="dot-stripe-live"></div>
                Live Environment (as opposed to Test API)
            </div>
            <div style="color:#777">
                <div class="dot-stripe-public"></div>
                Will show in Widget (as opposed to only being visible to you)
            </div>
        ...
        <!--<div id="wp-stripe-tab-projects">
				 ...
				 <table class="wp-stripe-projects">
					...
					<?php
        //wp_stripe_options_display_projects();
        // Content
        ...
        <div id="wp-stripe-tab-settings">
            ...
            <form action="options.php" method="post">
                ...
                <br/>
                <input name="Submit" type="submit" class="button button-primary button-large"
                       value="<?php _e('Save Changes', 'wp-stripe'); ?>"/>
            </form>

            <p style="margin-top:20px;color:#777">I highly suggest you test payments using the <strong>Test
                    Environment</strong> first. You can use the following details:</p>
            <ul style="color:#777">
        ...
        <div id="wp-stripe-tab-about">
            ...
            <p>This plugin was orginially created by <a href="http://www.twitter.com/noeltock"
                                                        target="_blank">@noeltock</a> and has now been expanded to be <a
                        href="http://hmn.md">Human Made</a> as a whole, follow us for updates &amp; other WordPress
                goodness.</p>
            <p>If you need any support, please use the <a
                        href="http://wordpress.org/tags/wp-stripe?forum_id=10">forums</a>, this is the only location we
                will provide support. If you are interested in contributing or raising development issues, please visit
                the <a href="https://github.com/humanmade/wp-stripe">Github respository</a>. Thank you!</p>
